...
//}
//
//KalmanFilter::KalmanFilter(float initial_x, float initial_y, float initial_yaw,
...
//std::vector<float> KalmanFilter::process(IMU& imu_data, GPS& gps_data) {
...
//void KalmanFilter::predict(IMU& imu_data) {
...
//	float yaw_rate_from_imu = imu_data.getGyroX();
...
//}
//
//void KalmanFilter::update(GPS& gps_data) {
...
//};
//
//std::pair<float, float> KalmanFilter::getPosition() const {
